...
export function Header() {
  return (
    <header className="flex flex-row h-20 justify-between mt-8 items-center bg-gradient-to-b from-white/20 to-white/60 px-4 rounded-lg">
      <h1 className="box-decoration-clone text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-pink-500 underline px-4 py-2 text-3xl font-bold">
      ...
      <div className="flex flex-row items-center">
        <ul className="m-0 p-0 list-none overflow-hidden bg-transparent">
          ...
          <li className="float-left mr-4 block px-4 py-2">
            <a href="#projects" className=" text-gray-900 hover:font-bold hover:text-white">
              Projects
            </a>
          </li>
          <li className="float-left mr-4 block px-4 py-2">
